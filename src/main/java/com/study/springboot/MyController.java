...
public class MyController {
    ...
    @RequestMapping("/test1")//test1/?id=김&name=자바 url창에 넣어준다
	...
	@RequestMapping("/test4/{studentId}/{name}")///test4/감/자바 url에 넣어준다 PathVariable방식이다
	public String getStudent(@PathVariable String studentId,//@PathVariable은 URL 경로에 변수를 넣어주는거
